...
function DAdminLayout({ children }) {
  ...
  return (
    <div className="admin-shell flex h-screen overflow-hidden bg-gray-50">
      {/* Sidebar */}
      <div
        className={`admin-sidebar flex flex-col justify-between fixed inset-y-0 left-0 z-50 transition-all duration-300 ease-in-out bg-white border-r border-gray-100 shadow-sm ${
      ...
      >
        ...
        <div>
          <div className="flex items-center justify-center h-20 border-b border-gray-100">
            <div className="admin-logo-mark flex items-center justify-center w-10 h-10 font-bold text-white bg-indigo-600 rounded-lg">
              D
            </div>
            {isSidebarOpen && (
                  ...
                  <button
                    ...
                    className={`flex items-center w-full px-3 py-3 rounded-xl text-sm transition-all duration-200 group ${
                      location.pathname === item.path
                        ? "admin-active bg-indigo-50 text-indigo-600 font-medium"
        ...
        <div className="px-4 py-3 border-t border-gray-100">
          ...
          >
            <div className="flex items-center justify-center w-8 h-8 text-white bg-white/15 rounded-lg">
              <HelpCircle size={18} />
            </div>
            {isSidebarOpen && (
              <div className="ml-3">
                <p className="text-sm font-medium text-white">Support</p>
                <p className="text-xs text-white/60">Get help 24/7</p>
              </div>
            )}
          </div>
        </div>
      ...
      >
        {/* Topbar */}
        <div className="admin-topbar sticky top-0 z-40 flex items-center justify-between h-16 px-6 bg-white border-b border-gray-100 shadow-sm">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="relative">
              ...
              >
                <div className="admin-avatar flex items-center justify-center w-8 h-8 font-medium text-white bg-indigo-600 rounded-lg">
                  A
                </div>
        ...
        {/* Page Content */}
        <div
          className="admin-content flex-1 p-6 overflow-y-auto"
